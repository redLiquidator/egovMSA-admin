...
var TreeItem = /*#__PURE__*/function (_Component) {
  ...
  (0, _createClass2.default)(TreeItem, [{
    ...
    value: function shouldComponentUpdate(nextProps) {
      return !(0, _react2.sameProps)(this.props, nextProps, ['item', 'provided', 'snapshot', 'onCollapse', 'onExpand']) || !(0, _path.isSamePath)(this.props.path, nextProps.path) || // also rerender tree item even if the item is not draggable, this allows draggable/nondraggable items to behave the same
